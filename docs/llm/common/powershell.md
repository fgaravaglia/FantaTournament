...
This guide provides PowerShell-specific instructions to help AI generate idiomatic, safe, and maintainable scripts. It aligns with Microsoft’s PowerShell cmdlet development guidelines.
